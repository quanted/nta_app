...
class NtaRun:
    ...
    def drop_duplicates(self):
        ...
        self.save_df_to_mongo('input_no_duplicates_pos', self.dfs[0])
        self.save_df_to_mongo('input_no_duplicates_neg', self.dfs[1])
        return
    ...
    def check_tracers(self):
        ...
        self.save_df_to_mongo('tracers_pos', self.tracer_dfs_out[0])
        self.save_df_to_mongo('tracers_neg', self.tracer_dfs_out[1])
        return
    ...
    def create_mongo_post(self):
        posts = self.mongo.posts
        time_stamp = datetime.utcnow()
        data = {'_id': self.jobid, 'date': time_stamp}
