...
d3.csv(csv_path).then(function(data) {
          ...
          if (i !== 0) {
            ...
            if (j === 0) {
              ...
              if (i === 1) {
                ...
                var cellText = document.createTextNode(numberWithCommas(objs[j-1]['nOverCVUnderMRL'] + objs[j-1]['nUnderCVUnderMRL'] + objs[j-1]['nMissing'] + objs[j-1]['nUnderRep']));
              } 
            }
          } 
  ...
  function createOccTree(occ_counts, divID, svgID) {
    ...
    let data = {
      name: `Initial Input Data  -  Total Occurrences (${svgID[7]})`,
      color: c_black,
      text_color: '#000',
      stroke: 'none',
      stroke_width: '3px',
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              name: "< Replicate Threshold",
              size: occ_counts['nUnderRep'],
              color: c_grey,
              text_color: '#FFF',
              stroke: '#fff',
              stroke_width: '2px',
              ...
              children: [
                  ...
                  children: [
                    {
                      name: "< MRL",
                      text_color: '#FFF',
                      size: occ_counts['nOverCVUnderMRL'],
                      color: c_grey,
                      stroke: '#fff',
                      stroke_width: '2px',
                      fontsize: '1.6rem',
                    ...
                    {
                      name: "\u2265 MRL",
                      size: occ_counts['nOverCVOverMRL'],
                      color: c_red,
                      text_color: '#FFF',
                      stroke: '#fff',
                      stroke_width: '2px',
                ...
                },
                {
                  ...
                  children: [
                    {
                      name: "< MRL",
                      size: occ_counts['nUnderCVUnderMRL'],
                      color: c_grey,
                      text_color: '#FFF',
                      stroke: '#fff',
                      stroke_width: '2px',
                    ...
                    {
                      name: "\u2265 MRL",
                      size: occ_counts['nUnderCVOverMRL'],
                      color: c_black,
                      text_color: '#000',
                      stroke: 'rgb(0, 141, 188)',
                      stroke_width: '4px',
                      fontsize: '1.9rem',
                      fontweight: 'bold'
                    }
    ...
    g.append("title")
      .text((d) => `${d.data.name}\n${numberWithCommas(d.value)}\n${Math.floor((d.value / occ_counts['nTotal'])*10000) / 100}%`)
