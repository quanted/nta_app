...
example_pos_mgf_filename = "EntactEnv_Pos_MS1_Dust1IDA_01_Debug.mgf"
example_neg_mgf_filename = "EntactEnv_Neg_MS1_Dust1IDA_01_Debug.mgf"
example_pos_msp_filename = "WW2DW-POCIS_ESI+_MSe_AllCompounds.msp"
example_neg_msp_filename = "WW2DW-POCIS_ESI-_MSe_AllCompounds.msp"
...
def formula_list_html(header, model, tables_html):
    ...
    # main body
    html += render_to_string("nta_main_content.html", {"TITLE": header + " References", "TEXT_PARAGRAPH": tables_html})
...
def download_test_files(request):
    ...
    pos_mgf_input = os.path.join(example_data_dir, example_pos_mgf_filename)
    neg_mgf_input = os.path.join(example_data_dir, example_neg_mgf_filename)
    pos_msp_input = os.path.join(example_data_dir, example_pos_msp_filename)
    neg_msp_input = os.path.join(example_data_dir, example_neg_msp_filename)

    # create filenames
    filename1 = "ms2_pos_input_test_data.mgf"
    filename2 = "ms2_neg_input_test_data.mgf"
    filename3 = "ms2_pos_input_test_data.msp"
    filename4 = "ms2_neg_input_test_data.msp"

    # List of files to be zipped
    files_to_zip = {
        filename1: pos_mgf_input,
        filename2: neg_mgf_input,
        filename3: pos_msp_input,
        filename4: neg_msp_input,
    }
