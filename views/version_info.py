...
# # @require_POST
# def version_info_page(
#     request, model="ms1", header="Download MS1 test files", jobid="00000000"
# ):
#     model_html = """<div id="Download button"><input type="button" value="Download MS1 Test Files" onclick="window.open('download')">
# </div>"""
#     html = version_info_html(header, model, model_html)
...
#         {"TITLE": header + " References", "TEXT_PARAGRAPH": tables_html},
#     )
...
#         filename1: pos_input,
#         filename2: neg_input,
#         filename3: tracer_file,
#         filename4: run_sequence_pos_file,
#         filename5: run_sequence_neg_file,
#     }
