    ...
    if request.method == "POST":
        ...
        try:
            ...
            parameters = {
                ...
                "pos_adducts": data.getlist("pos_adducts[]", []),
                "neg_adducts": data.getlist("neg_adducts[]", []),
                "neutral_losses": data.getlist("neutral_losses[]", []),
            ...
            if inputParameters["do_atom_filtering"][1] == "yes":
                ...
                us_atom_dict_li = json.loads(data.get("atom_ranges"))
